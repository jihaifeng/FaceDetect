...
public class BitmapUtils {
  ...
  public static Bitmap covBitmapFromUri(Context context, Uri uri, int maxWidth, int maxHeight) {
    ...
    Bitmap bitmap = null;
    try {
      bitmap = covBitmapFrmUri(context, uri, options);
    } catch (Throwable e) {
      e.printStackTrace();
    }
    return bitmap;
  ...
  public static Bitmap covBitmapFrmUri(Context context, Uri uri, BitmapFactory.Options options) {
    if (uri == null) {
      return null;
    }
  ...
  public static Bitmap covBitmapFrmUriWithOpt(Context context, Uri uri) {

    return covBitmapFrmUri(context, uri, getOpts(context));
  }
